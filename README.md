...
- [Running NeurOcean](#running-neurocean)
...
NeurOcean applies this exact architecture to one of Earth's most urgent environmental crises: **coral reef collapse**.
...
NeurOcean compresses decades of potential research into hours.

---

## What It Does

NeurOcean is a three-layer system:
...
```bash
git clone https://github.com/AbhinavGGarg/NeurOcean.git
cd neurocean
python -m venv .venv
